                    ...
                    <form class="card login-form" method="post" action="{{route('login')}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-between bottom-content">
                                ...
                                <a class="lost-pass" href="account-password-recovery.html">{{__('Forgot password?')}}</a>
                                @endif
                            ...
                            @if (Route::has('register'))
                             <p class="outer-link">{{__("Don't have an account?")}} <a href="register.html">{{__('Register here')}} </a>
                            @endif
